...
<html dir="ltr" lang="en">
	...
	<body class='index'>
		...
		<nav>
          ...
          <a href="${mvc.basePath}/token">Token</a>
					<a href="${mvc.basePath}/todos">To-Dos</a>
					<a href="${mvc.basePath}/todos?status=Complete">Complete To-Dos</a>
					<a href="${mvc.basePath}/todos?status=Incomplete">Incomplete To-Dos</a>
				</li>
			</ul>
		</nav>
		<main>
